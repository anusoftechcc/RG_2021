...
#ifndef SWIFTYPICKERPOPOVER_SWIFT_H
#define SWIFTYPICKERPOPOVER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftyPickerPopover",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface ColumnStringPickerPopoverViewController (SWIFT_EXTENSION(SwiftyPickerPopover)) <UIPickerViewDelegate>
...
@interface ColumnStringPickerPopoverViewController (SWIFT_EXTENSION(SwiftyPickerPopover)) <UIPickerViewDataSource>
...
@interface StringPickerPopoverViewController (SWIFT_EXTENSION(SwiftyPickerPopover)) <UIPickerViewDataSource>
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView * _Nonnull)pickerView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)pickerView:(UIPickerView * _Nonnull)pickerView numberOfRowsInComponent:(NSInteger)component SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface StringPickerPopoverViewController (SWIFT_EXTENSION(SwiftyPickerPopover)) <UIPickerViewDelegate>
